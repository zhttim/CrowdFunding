                ...
                <div class="panel-body">
                    <form action="admin/save.html" method="post" role="form">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="loginAcct" class="form-control" id="InputLogin" placeholder="请输入登录账号">
                        </div>
                        <div class="form-group">
                            <label for="InputPassword">登录密码</label>
                            <input type="password" name="userPswd" class="form-control" id="InputPassword"
                                   placeholder="请输入登录密码">
                        </div>
                        <div class="form-group">
                            <label for="InputUserNmae">用户昵称</label>
                            <input type="text" name="userName" class="form-control" id="InputUserNmae"
                                   placeholder="请输入用户昵称">
                        </div>
                        <div class="form-group">
