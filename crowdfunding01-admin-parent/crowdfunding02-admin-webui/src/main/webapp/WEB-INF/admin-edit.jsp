                ...
                <div class="panel-body">
                    <form action="admin/update.html" method="post" role="form">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="loginAcct" value="${requestScope.admin.loginAcct}" class="form-control"
                                   id="InputLogin" placeholder="请输入登录账号">
                        </div>
                        <div class="form-group">
                            <label for="InputUserNmae">用户昵称</label>
                            <input type="text" name="userName" value="${requestScope.admin.userName}"
                                   class="form-control" id="InputUserNmae" placeholder="请输入用户昵称">
                        </div>
                        <div class="form-group">
